...
def keygen(lo, hi):
    ...
    # choosing two distinguished prime in range of lo, hi using the _primes
...
def _primes(lo, hi):
    # empty list to fil with prime numbers

    prime_empty = []
    # run the prime_counter program from project_2 with a little
    # modification
...
def _choice(a):
    ...
    # this just taking the random index from c and returning
    # the i th item of a
